...
#def Red_AI(sense,red):
    #if sense==1 and red.y - VEL > 0: #Up
        #red.y -= VEL
    #if sense==2 and red.y + VEL + red.height < Height-10: #Down
        #red.y += VEL
...
#Imported image
Space_background = pygame.transform.scale(pygame.image.load(os.path.abspath('Asset Project 1\Play.png')),(Width,Height))
Space_background1 = pygame.transform.scale(pygame.image.load(os.path.abspath('Asset Project 1\space.png')),(Width,Height))
Yellow_spaceship_Image = pygame.image.load(os.path.abspath('Asset Project 1\spaceship_yellow.png'))
...
Red_spaceship_Image = pygame.image.load(os.path.abspath('Asset Project 1\spaceship_red.png'))
Red_spaceship = pygame.transform.rotate(pygame.transform.scale(Red_spaceship_Image,(Spaceship_width,Spaceship_height)),90)
Spaceship_guns_sound =pygame.mixer.Sound(os.path.abspath('Asset Project 1\Assets_Gun+Silencer.mp3'))
Spaceship_hits_sound =pygame.mixer.Sound(os.path.abspath('Asset Project 1\Assets_Grenade+1.mp3'))
Space_End_image = pygame.image.load(os.path.abspath('Asset Project 1\Explosion_ship.png'))
Space_End = pygame.transform.scale(Space_End_image,(Spaceship_width,Spaceship_height))
Explosion_sound =pygame.mixer.Sound(os.path.abspath('Asset Project 1\ES_Sci Fi Explosion 4 - SFX Producer.mp3'))
Shaceship_eng_sound =pygame.mixer.Sound(os.path.abspath('Asset Project 1\Rocket-sound-effect.mp3'))
Loaded_up_sound=pygame.mixer.Sound(os.path.abspath('Asset Project 1\mixkit-clock-countdown-bleeps-916.wav'))
 ...
 #   count_d=Winner_font.render(str(countdown),1,White)
  #  DISPLAYSURF.blit(count_d,(450,150))
   # pygame.display.update()
    ...
    #DISPLAYSURF.fill(Black)
    #pygame.display.update()
pygame.mixer.Channel(0).play(pygame.mixer.Sound(os.path.join('C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Python 3.10\Asset Project 1', 'New.mp3')),loops=-1)
Start1=True
